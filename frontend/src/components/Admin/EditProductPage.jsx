...
const EditProductPage = () => {
    ...
    const [productData,setProductData]=useState({
         ...
         images:[
            {
                url:"https://picsum.photos/150?random=150",
            },
            {
  ...
  return (
   ...
   <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
    ...
    <form action="" onSubmit={handleSubmit}>
        ...
        {/* Description */}
        <div className="mb-6">
            <label htmlFor="" className="block font-semibold mb-2">Product Description</label>
        ...
        {/* Price */}
         ...
         <div className="mb-6">
            <label className='block font-semibold mb-2'>Color (Comma-Seperated)</label>
            <input type="text"
            name='colors'
